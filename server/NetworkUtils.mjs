...
function preloadFromResponse(part, preloadAsset) {
  ...
  if (extensions$1 !== undefined) {
    Core__Option.getWithDefault(Core__Option.map(Caml_option.valFromOption(extensions$1)["preloadableImages"], (function (images) {
                  return Core__Array.filterMap(Core__Option.getWithDefault(Js_json.decodeArray(images), []), Js_json.decodeString);
    ...
    if (arrayData !== undefined) {
      return Core__Option.flatMap(sequence(arrayData.map(parseFn)), (function (data) {
                    return {
                            ...
                            _0: {
                              incremental: data,
                              hasNext: Core__Option.mapWithDefault(Js_dict.get(dict$1, "hasNext"), false, (function (v) {
                                      return Core__Option.mapWithDefault(Js_json.decodeBoolean(v), false, (function (v) {
                                                    return v;
                                                  }));
                                    }))
                            }
