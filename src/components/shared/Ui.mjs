...
import * as Model from "../../models/Model.mjs";
  ...
  var makeDefault = function (source) {
    return JsxRuntime.jsx(ReactImgix, {
                ...
                imgixParams: (function (params) {
                      return Belt_Option.getWithDefault(Belt_Option.map(params !== undefined ? params : imgixParams, Model.ImgixParams.addDefaults), Model.ImgixParams.defaults);
                    })(source.imgixParams),
                width: source.width,
...
function make$2(props) {
  ...
  return JsxRuntime.jsxs(JsxRuntime.Fragment, {
              children: [
                ...
                process.env.NODE_ENV === "development" ? JsxRuntime.jsx(make$1, {
                        src: src,
                        className: className,
                        alt: alt,
                        lazyLoad: lazyLoad
                        ...
                        imgixParams: Belt_Option.getWithDefault(Belt_Option.map(imgixParams, Model.ImgixParams.addDefaults), Model.ImgixParams.defaults),
                        domain: domain,
                        width: width,
                        height: height,
                        disableLibraryParam: true
