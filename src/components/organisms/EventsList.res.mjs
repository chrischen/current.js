...
import * as Util from "../shared/Util.res.mjs";
...
import * as EventsList_event_graphql from "../../__generated__/EventsList_event_graphql.res.mjs";
import * as EventsListFragment_graphql from "../../__generated__/EventsListFragment_graphql.res.mjs";
import * as EventsListRefetchQuery_graphql from "../../__generated__/EventsListRefetchQuery_graphql.res.mjs";
  ...
  return JsxRuntime.jsxs(ReactRouterDom.Link, {
              ...
              children: [
                ...
                JsxRuntime.jsx(ReactIntl.FormattedDate, {
                      value: Core__Option.getOr((function (__x) {
                                return Core__Option.map(__x, Util.Datetime.toDate);
                              })(match.startDate), new Date("2024-01-01"))
                    })
              ]
            });
}
